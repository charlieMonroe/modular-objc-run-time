 ...
 */
static inline unsigned int _cache_bucket_index_for_selector(_objc_cache table, const SEL selector){
...
static inline unsigned int _objc_cache_log2u(unsigned int x) { return (x<2) ? 0 : _objc_cache_log2u (x>>1)+1; };
 ...
 */
static inline void _cache_initialize_buckets(_objc_cache table){
	table->buckets = objc_zero_alloc(table->bucket_count * sizeof(_objc_cache_bucket));
}

static inline _objc_cache cache_create_internal(){
...
static inline void cache_insert_method(_objc_cache cache, Method m){
...
static inline Method cache_fetch_method(_objc_cache cache, SEL key) {
...
static inline objc_cache objc_cache_create(void){
	return (objc_cache)cache_create_internal();
}
static inline Method objc_cache_fetch(objc_cache cache, SEL selector){
	return cache_fetch_method((_objc_cache)cache, selector);
}
static inline void objc_cache_insert(objc_cache cache, Method method){
