...
objc_runtime_create_getter_setter_function_body(objc_rw_lock_creator, rw_lock_creator, sync.rwlock.creator)
objc_runtime_create_getter_setter_function_body(objc_rw_lock_destroyer, rw_lock_destroyer, sync.rwlock.destroyer)
objc_runtime_create_getter_setter_function_body(objc_rw_lock_read_lock, rw_lock_rlock, sync.rwlock.rlock)
objc_runtime_create_getter_setter_function_body(objc_rw_lock_write_lock, rw_lock_wlock, sync.rwlock.wlock)
objc_runtime_create_getter_setter_function_body(objc_rw_lock_unlock, rw_lock_unlock, sync.rwlock.unlock)
objc_runtime_create_getter_setter_function_body(objc_array_creator, array_creator, array.creator)
objc_runtime_create_getter_setter_function_body(objc_array_lockable_creator, array_lockable_creator, array.lockable_creator)
objc_runtime_create_getter_setter_function_body(objc_array_destroyer, array_destroyer, array.destroyer)
objc_runtime_create_getter_setter_function_body(objc_array_getter, array_getter, array.getter)
objc_runtime_create_getter_setter_function_body(objc_array_append, array_append, array.append)
