...
void objc_class_holder_rlock(objc_class_holder holder){
	objc_hash_table_rlock((_objc_hash_table)holder);
}
void objc_class_holder_wlock(objc_class_holder holder){
	objc_hash_table_wlock((_objc_hash_table)holder);
}
void objc_class_holder_unlock(objc_class_holder holder){
