...
\begin{figure}
  ...
  static void init_kalisto(void){
    ...
    objc_runtime_set_rw_lock_rlock((objc_rw_lock_read_lock_f)mutex_lock);
    objc_runtime_set_rw_lock_wlock((objc_rw_lock_write_lock_f)mutex_lock);
    objc_runtime_set_rw_lock_unlock((objc_rw_lock_unlock_f)mutex_unlock);
  }
  \end{verbatim}
  \centering{}
